-- 1. Qual é o preço médio, máximo e mínimo dos produtos?
...
-- 2. Quantos produtos existem em cada categoria?
...
-- 3. Quais são as categorias distintas existentes na tabela de produtos?
...
-- 4. Quais categorias possuem mais de 2 produtos?
SELECT categoria FROM produtos GROUP BY categoria HAVING COUNT(*) > 2;

# Somente a categoria: Eletrônicos

-- 5. Quais são os produtos que possuem a palavra "Livro" em seu nome?
SELECT id FROM produtos WHERE nome LIKE '%Livro%';

# Somente o produto 6

-- 6. Quais são os 3 produtos mais caros?
...
-- 7. Quais produtos têm o preço dentro do intervalo de R$ 50 a R$ 100?
...
-- 8. Quais são os produtos com ID 1, 3 e 5?
...
-- 9. Qual é o valor total gasto em produtos da categoria "Eletrônicos"?
SELECT SUM(preco) AS valor_total_gasto FROM produtos WHERE categoria = 'Eletrônicos';

# O valor total gasto é: 999.97

-- 10. Quais são os produtos que pertencem às categorias "Vestuário" ou "Acessórios" e possuem um preço entre R$ 30 e R$ 50?
